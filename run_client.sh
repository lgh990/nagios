...
#Usage:			To begin installing nagios on remote host automatically
#Attention:	

NAGIOS_INSTALL_DIR=/usr/local
TOOLS_NAME=nagios_tools_for_client
...
dos2unix scripts/*
cd scripts/
sh auto_install_client.sh 2>&1 | tee $NAGIOS_INSTALL_DIR/$TOOLS_NAME/log/nagios_install.log